...
;(() => {
  ...
  if (navigator.language.toLocaleLowerCase() == "zh-cn") {
    ...
    gv.btnText = {
      max: "Maximize,Hotkey-Esc",
      pip: "PicInPic,Hotkey-F2",
  ...
  const setButton = {
    ...
    locate() {
      ...
      gv.controlBtn.style.left = playerRect.screenX - 200 + gv.player.offsetWidth + "px"
      ...
      gv.picinpicBtn.style.left = playerRect.screenX - 405 + gv.player.offsetWidth + "px"
    },
  }
